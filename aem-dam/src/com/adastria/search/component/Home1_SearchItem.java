...
// Test Case 1: Opening the home page
//Typing a Keyword
//Checking for Auto-complete
//Clicking the keyword from the auto-complete drop down and click the submit button
public class Home1_SearchItem extends MainMenu_Test{
