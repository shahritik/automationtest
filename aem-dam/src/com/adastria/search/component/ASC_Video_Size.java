...
//check if size is displayed in the metadata of the video assets

public class ASC_Video_Size extends MainMethod{
	...
	public static void displaysize() throws InterruptedException, IOException
	{
		...
		Thread.sleep(1000);
			...
			if (header.equals("サイズ")==true)
			{
				...
				//ASSERTION CONDITION
				//check if the value of size is displayed on KB, MB, GB or TB
				if(correct(str)==true)
				{
