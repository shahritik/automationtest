...
public class ASC_Document_Actions extends MainMethod{
	...
	public static void check_download() throws InterruptedException, IOException
	{
		...
		driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div[1]/header/div/div/a[6]/i")).click();
		Thread.sleep(1000);
		//get a list of all the actions that can be performed on document asset
	...
	private static boolean element_exits() {
		WebElement el;
		try {
        	el=driver.findElement(By.xpath("//*[@id=\"rail\"]/div/div/div/div/div/div[2]/div/div/button"));
		} catch (Exception e) {
			return false;	
		}	
		return true;
