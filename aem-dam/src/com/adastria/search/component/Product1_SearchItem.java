...
public class Product1_SearchItem extends MainMethod{
	
	static String brand="";
	
	public static void searchItem_product() throws IOException, InterruptedException
	{
	//click on the ITEM button of the header
