...
public class ASC_Video_Metadata extends MainMethod{
	...
	public static void metadata_display() throws InterruptedException, IOException
	{
		...
		Thread.sleep(1000);
		//ASSERTION CONDITION
		//click on another video asset, extract the header of metadata and store it an array (ar1)
		//check the equality for ar and ar1
		if(correctmetadatadisplayed(list, list1, ar)==true)
		{
			test.log(LogStatus.PASS, "メタデータがすべて表示されていること", test.addScreenCapture(screenshotPath));
		}
		else
		{
