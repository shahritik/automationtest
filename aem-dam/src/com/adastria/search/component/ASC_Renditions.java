...
public class ASC_Renditions extends MainMethod{
	...
	public static void check_renditions() throws IOException, InterruptedException
	{
		//clicking on the home button
			...
			//get the title of the image asset	
		String title=driver.findElement(By.xpath("/html/body/div/div/div/div[1]/div/div/div[2]/div/div[4]/form/div/div/div[1]/div/article[10]/div[1]/h3/a")).getText();
		Thread.sleep(1000);
		//open the image assets
		driver.findElement(By.xpath("/html/body/div/div/div/div[1]/div/div/div[2]/div/div[4]/form/div/div/div[1]/div/article[10]/div[1]/h3/a")).click();
		Thread.sleep(1000);
		//open the side panel
		driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div[1]/header/div/div/a[6]/i")).click();
		Thread.sleep(1000);
	...
	private static boolean click(WebElement el, String title, String rendition) throws InterruptedException {
        ...
        for (int i = 0; i<dirContents.length; i++) {
            if (dirContents[i].getName().equals(title+" - "+rendition+".jpeg")==true || dirContents[i].getName().equals(title+" - "+rendition+".png")==true || dirContents[i].getName().equals(title+" - "+rendition+".jpg")==true) {
